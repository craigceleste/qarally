...
// Facke Responses from Rally Web Services.

// Used as inputs for testing Rally Service.

window.rallyHttpFakes = {
  create: function() {
    return {
      ...
      "SubscriptionWorkspacesResponse": {
        "QueryResult": {
          "Errors": [], 
          "PageSize": 20, 
          "Results": [
      ...
      // https://rally1.rallydev.com/slm/webservice/v3.0/Workspace/286f4675-fc38-4a87-89b9-eec25d199cab/Projects
      ...
      // https://rally1.rallydev.com/slm/webservice/v3.0/Project/d0e34bc7-55c0-4757-857d-6be2604a6c6c/Iterations

      "ProjectIterationsResponse": {
        "QueryResult": {
          "Errors": [], 
          "PageSize": 200, 
          "Results": [
      ...
      // https://rally1.rallydev.com/slm/webservice/v3.0/TestSet/af931b07-a8d0-4157-87a3-9772e435a8da/TestCases

      "TestSetTestCasesResponse": {
        "QueryResult": {
          "Errors": [], 
          "PageSize": 200, 
          "Results": [
      ...
      // https://rally1.rallydev.com/slm/webservice/v3.0/TestCaseResult
      //    ?fetch=true

      "TestCaseResultListFetchResponse": {
        "QueryResult": {
          "Errors": [], 
          "PageSize": 200, 
          "Results": [
