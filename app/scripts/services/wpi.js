...
angular.module('qa-rally').factory('Wpi', ['$log', '$q', '$window', 'Rally', function($log, $q, $window, Rally) {
  ...
  service.wpiIsValid = function(wpi) {
    ...
    return wpi && wpi.workspaceRef && wpi.projectRef && wpi.iterationRef && wpi.label ? true : false;
  };
